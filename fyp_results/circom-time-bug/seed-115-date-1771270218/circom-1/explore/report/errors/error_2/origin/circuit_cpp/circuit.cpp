...
uint get_total_signal_no() {return 83;}
...
main_template_7_run(coffset,ctx);
}
...
IsEqual_1_create(mySignalStart+31,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
Mux1_3_create(mySignalStart+42,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
Mux1_3_create(mySignalStart+50,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
Mux1_3_create(mySignalStart+58,17+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 17+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
IsEqual_1_create(mySignalStart+66,19+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 19+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
NOT_4_create(mySignalStart+72,21+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 21+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
Mux1_3_create(mySignalStart+74,22+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 22+ctx_index+1;
}
{
...
XOR_5_create(mySignalStart+13,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_14";
IsZero_0_create(mySignalStart+16,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_15";
NOT_4_create(mySignalStart+19,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_16";
XOR_5_create(mySignalStart+21,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_17";
NOT_4_create(mySignalStart+24,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_18";
NOT_4_create(mySignalStart+26,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_19";
AND_6_create(mySignalStart+28,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_20";
IsZero_0_create(mySignalStart+37,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_21";
NOT_4_create(mySignalStart+40,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[16] = 12+ctx_index+1;
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
// load src
Fr_neg(&expaux[0],&signalValues[mySignalStart + 0]); // line circom 47
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 10;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[1]); // line circom 58
}}
...
cmp_index_ref_load = 16;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + 0],&circuitConstants[1]); // line circom 73
}}
