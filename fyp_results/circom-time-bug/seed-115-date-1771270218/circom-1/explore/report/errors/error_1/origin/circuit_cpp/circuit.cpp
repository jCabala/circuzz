...
IsZero_1_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
NOT_0_create(mySignalStart+6,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
IsZero_1_create(mySignalStart+8,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
NOT_0_create(mySignalStart+13,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
Mux1_3_create(mySignalStart+15,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
Mux1_3_create(mySignalStart+23,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
IsEqual_4_create(mySignalStart+31,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
NOT_0_create(mySignalStart+37,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
IsZero_1_create(mySignalStart+39,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
NOT_0_create(mySignalStart+11,2+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 2;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[0]); // line circom 22
}}
...
// load src
Fr_mul(&expaux[0],&circuitConstants[6],&signalValues[mySignalStart + 3]); // line circom 34
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 8;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0],&circuitConstants[0]); // line circom 44
}}
