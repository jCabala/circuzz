...
IsEqual_1_create(mySignalStart+13,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
NOT_2_create(mySignalStart+19,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
Mux1_4_create(mySignalStart+21,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
AND_5_create(mySignalStart+29,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
Mux1_4_create(mySignalStart+32,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
Mux1_4_create(mySignalStart+40,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
AND_5_create(mySignalStart+48,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
Mux1_4_create(mySignalStart+51,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
AND_5_create(mySignalStart+2,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
XOR_6_create(mySignalStart+5,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
IsZero_0_create(mySignalStart+8,2+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 11;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0],&circuitConstants[1]); // line circom 51
}}
