...
uint get_size_of_witness() {return 268;}
...
GreaterThan_2_create(mySignalStart+1,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_3_create(mySignalStart+261,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
OR_4_create(mySignalStart+265,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
AND_5_create(mySignalStart+268,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
IsEqual_7_create(mySignalStart+271,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
NOT_3_create(mySignalStart+277,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
OR_4_create(mySignalStart+279,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
AND_5_create(mySignalStart+282,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
Mux1_9_create(mySignalStart+285,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
IsZero_6_create(mySignalStart+293,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
NOT_3_create(mySignalStart+263,4+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 10;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[2]); // line circom 41
}}
