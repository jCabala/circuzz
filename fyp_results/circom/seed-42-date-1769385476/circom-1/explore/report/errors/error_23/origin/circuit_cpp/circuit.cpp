...
uint get_total_signal_no() {return 296;}

uint get_number_of_components() {return 14;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 296;}
...
Mux1_1_create(mySignalStart+2,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
Mux1_1_create(mySignalStart+10,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
Mux1_1_create(mySignalStart+18,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
LessThan_3_create(mySignalStart+26,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
NOT_4_create(mySignalStart+283,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
IsZero_5_create(mySignalStart+285,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
NOT_4_create(mySignalStart+288,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
IsZero_5_create(mySignalStart+290,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
NOT_4_create(mySignalStart+293,12+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 6;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],&circuitConstants[0]); // line circom 34
}}
...
cmp_index_ref_load = 8;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0],&circuitConstants[0]); // line circom 39
}}
