...
AND_0_create(mySignalStart+2,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
OR_1_create(mySignalStart+5,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
AND_0_create(mySignalStart+16,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
OR_1_create(mySignalStart+19,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
OR_1_create(mySignalStart+22,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
XOR_2_create(mySignalStart+25,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
XOR_2_create(mySignalStart+28,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
AND_0_create(mySignalStart+31,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
OR_1_create(mySignalStart+34,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
OR_1_create(mySignalStart+37,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
AND_0_create(mySignalStart+8,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
IsZero_3_create(mySignalStart+11,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
NOT_4_create(mySignalStart+14,4+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 12;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&circuitConstants[2]); // line circom 47
}}
