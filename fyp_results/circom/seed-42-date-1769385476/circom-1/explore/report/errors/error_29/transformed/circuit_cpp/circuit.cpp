...
void XOR_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void XOR_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 579;}

uint get_number_of_components() {return 22;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 531;}
...
NOT_0_create(mySignalStart+9,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_0_create(mySignalStart+11,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
LessThan_2_create(mySignalStart+304,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
NOT_0_create(mySignalStart+561,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
XOR_3_create(mySignalStart+563,16+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 16+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
XOR_3_create(mySignalStart+566,17+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 17+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
OR_4_create(mySignalStart+569,18+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 18+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
OR_4_create(mySignalStart+572,19+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 19+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
OR_4_create(mySignalStart+575,20+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 20+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
LessThan_2_create(mySignalStart+13,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
NOT_0_create(mySignalStart+270,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_14";
Mux1_6_create(mySignalStart+272,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_16";
Mux1_6_create(mySignalStart+280,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_17";
Mux1_6_create(mySignalStart+288,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_19";
Mux1_6_create(mySignalStart+296,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 11+ctx_index+1;
}
// load src
// end load src
signalValues[mySignalStart + 0] = signalValues[mySignalStart + 2];
{
uint cmp_index_ref = 0;
// load src
// end load src
...
// load src
// end load src
signalValues[mySignalStart + 3] = 1ull;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
XOR_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
// load src
// end load src
signalValues[mySignalStart + 4] = 4294967293ull;
// load src
// end load src
signalValues[mySignalStart + 5] = Fr_bnot(Fr_add(signalValues[mySignalStart + 0],0ull));
{
...
// load src
// end load src
signalValues[mySignalStart + 6] = Fr_div(signalValues[mySignalStart + 2],8562679397594381875ull);
{
if (!Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 6],8562679397594381875ull),signalValues[mySignalStart + 2]))) std::cout << "Failed assert in template/function " << myTemplateName << " line 55. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 6],8562679397594381875ull),signalValues[mySignalStart + 2])));
}
{
uint cmp_index_ref = 12;
// load src
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1] = 10533494783209362882ull;
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
...
// load src
// end load src
signalValues[mySignalStart + 7] = Fr_band(3635504398113811420ull,Fr_mul(5247613925312444266ull,signalValues[mySignalStart + 0]));
{
...
cmp_index_ref_load = 13;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1] = Fr_mul(ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + 0],signalValues[mySignalStart + 7]);
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
...
cmp_index_ref_load = 11;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2] = Fr_sub(5538979617346442436ull,ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0]);
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
...
cmp_index_ref_load = 14;
// end load src
signalValues[mySignalStart + 8] = Fr_div(Fr_neg(Fr_neg(ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0])),1ull);
{
cmp_index_ref_load = 14;
cmp_index_ref_load = 14;
if (!Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 8],1ull),Fr_neg(Fr_neg(ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0]))))) std::cout << "Failed assert in template/function " << myTemplateName << " line 72. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 8],1ull),Fr_neg(Fr_neg(ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0])))));
}
// load src
// end load src
signalValues[mySignalStart + 1] = signalValues[mySignalStart + 8];
{
printf("<@> out0 = ");
}
{
