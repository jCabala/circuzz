...
uint get_total_signal_no() {return 574;}

uint get_number_of_components() {return 20;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 510;}
...
NOT_0_create(mySignalStart+8,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_0_create(mySignalStart+10,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
GreaterEqThan_3_create(mySignalStart+44,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
XOR_4_create(mySignalStart+304,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
OR_5_create(mySignalStart+307,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
OR_5_create(mySignalStart+310,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
GreaterEqThan_3_create(mySignalStart+313,16+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 16+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
Mux1_7_create(mySignalStart+12,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
Mux1_7_create(mySignalStart+20,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_13";
Mux1_7_create(mySignalStart+28,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_15";
Mux1_7_create(mySignalStart+36,8+ctx_index+1,ctx,new_cmp_name,myId);
...
// load src
// end load src
signalValues[mySignalStart + 5] = Fr_bnot(signalValues[mySignalStart + 0]);
{
...
{
if (!Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 6],8562679397594381875ull),signalValues[mySignalStart + 2]))) std::cout << "Failed assert in template/function " << myTemplateName << " line 45. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
cmp_index_ref_load = 9;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1] = Fr_mul(ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],signalValues[mySignalStart + 7]);
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
...
cmp_index_ref_load = 7;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2] = Fr_sub(5538979617346442436ull,ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]);
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
