...
void main_template_4_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void main_template_4_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 36;}
...
NOT_0_create(mySignalStart+1,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_0_create(mySignalStart+3,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
AND_1_create(mySignalStart+13,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
AND_1_create(mySignalStart+16,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
OR_2_create(mySignalStart+19,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
OR_2_create(mySignalStart+22,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
NOT_0_create(mySignalStart+25,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
NOT_0_create(mySignalStart+27,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
AND_1_create(mySignalStart+29,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
OR_2_create(mySignalStart+32,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
OR_2_create(mySignalStart+5,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
IsZero_3_create(mySignalStart+8,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
NOT_0_create(mySignalStart+11,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 4+ctx_index+1;
}
{
...
cmp_index_ref_load = 12;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&circuitConstants[0]); // line circom 42
}}
...
main_template_4_create(1,0,ctx,"main",0);
main_template_4_run(0,ctx);
}
