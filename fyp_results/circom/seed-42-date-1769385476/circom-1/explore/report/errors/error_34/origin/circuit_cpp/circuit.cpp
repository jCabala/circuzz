...
void MultiMux1_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiMux1_7_run(uint ctx_index,Circom_CalcWit* ctx);
void Mux1_8_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Mux1_8_run(uint ctx_index,Circom_CalcWit* ctx);
void AND_9_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void AND_9_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 297;}

uint get_number_of_components() {return 15;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 270;}
...
MultiMux1_7_create(mySignalStart+4,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[0];
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MultiMux1_7_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
NOT_2_create(mySignalStart+15,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
OR_3_create(mySignalStart+17,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
NOT_2_create(mySignalStart+20,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
LessEqThan_6_create(mySignalStart+22,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
Mux1_8_create(mySignalStart+282,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
AND_9_create(mySignalStart+290,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
OR_3_create(mySignalStart+293,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
IsZero_0_create(mySignalStart+10,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
NOT_2_create(mySignalStart+13,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 3+ctx_index+1;
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 2];
// load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Mux1_8_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
AND_9_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
cmp_index_ref_load = 9;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],&circuitConstants[1]); // line circom 43
}}
