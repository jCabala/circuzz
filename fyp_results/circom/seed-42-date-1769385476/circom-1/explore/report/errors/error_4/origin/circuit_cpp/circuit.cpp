...
uint get_total_signal_no() {return 608;}

uint get_number_of_components() {return 29;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 608;}
...
Mux1_1_create(mySignalStart+10,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
Mux1_1_create(mySignalStart+18,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
GreaterThan_4_create(mySignalStart+339,23+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 23+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
Mux1_1_create(mySignalStart+599,26+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 26+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
LessThan_3_create(mySignalStart+26,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
Mux1_1_create(mySignalStart+283,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
NOT_5_create(mySignalStart+291,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_15";
IsEqual_7_create(mySignalStart+293,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_16";
NOT_5_create(mySignalStart+299,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_17";
OR_8_create(mySignalStart+301,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_18";
IsEqual_7_create(mySignalStart+304,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_19";
Mux1_1_create(mySignalStart+310,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_20";
Mux1_1_create(mySignalStart+318,17+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 17+ctx_index+1;
}
{
std::string new_cmp_name = "comp_21";
Mux1_1_create(mySignalStart+326,19+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 19+ctx_index+1;
}
{
std::string new_cmp_name = "comp_22";
IsZero_6_create(mySignalStart+334,21+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 21+ctx_index+1;
}
{
std::string new_cmp_name = "comp_23";
NOT_5_create(mySignalStart+337,22+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 22+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
...
// load src
Fr_sub(&expaux[0],&circuitConstants[8],&signalValues[mySignalStart + 1]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 4]); // line circom 35
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 4]); // line circom 37
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 15;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[15]].signalStart + 0],&circuitConstants[0]); // line circom 80
}}
