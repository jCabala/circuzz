...
IsEqual_3_create(mySignalStart+10,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
NOT_4_create(mySignalStart+16,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
AND_5_create(mySignalStart+18,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
NOT_4_create(mySignalStart+21,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
IsZero_2_create(mySignalStart+23,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
NOT_4_create(mySignalStart+26,8+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 6;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],&circuitConstants[0]); // line circom 31
}}
