...
# circom-compile
  ...
  * command: `/root/.cargo/bin/circom --output /tmp/circom-1/explore/working/origin --r1cs --sym --wasm --c --json --prime bls12381 --O2 -l /circuzz/circomlib/circuits /tmp/circom-1/explore/working/origin/circuit.circom`
  * time: `0.6984529495239258s`
  * returncode: `0`

### STDOUT
~~~
template instances: 6
non-linear constraints: 2543
