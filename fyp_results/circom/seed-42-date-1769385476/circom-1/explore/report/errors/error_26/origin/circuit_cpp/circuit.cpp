...
uint get_total_signal_no() {return 318;}

uint get_number_of_components() {return 24;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 258;}
...
NOT_2_create(mySignalStart+298,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
AND_3_create(mySignalStart+300,16+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 16+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
OR_4_create(mySignalStart+303,17+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 17+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
NOT_2_create(mySignalStart+306,18+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 18+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
OR_4_create(mySignalStart+308,19+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 19+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
NOT_2_create(mySignalStart+311,20+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 20+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
NOT_2_create(mySignalStart+313,21+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 21+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
NOT_2_create(mySignalStart+315,22+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 22+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
NOT_2_create(mySignalStart+9,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
NOT_2_create(mySignalStart+11,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
Mux1_6_create(mySignalStart+13,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_13";
GreaterEqThan_9_create(mySignalStart+21,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_14";
NOT_2_create(mySignalStart+281,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_15";
NOT_2_create(mySignalStart+283,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_16";
Mux1_6_create(mySignalStart+285,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_17";
IsZero_0_create(mySignalStart+293,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[16] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_18";
NOT_2_create(mySignalStart+296,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[17] = 14+ctx_index+1;
}
// load src
// end load src
signalValues[mySignalStart + 0] = signalValues[mySignalStart + 1];
// load src
// end load src
signalValues[mySignalStart + 2] = 0ull;
{
...
cmp_index_ref_load = 11;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2] = ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0];
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
...
cmp_index_ref_load = 17;
if (!Fr_isTrue(Fr_eq(ctx->signalValues[ctx->componentMemory[mySubcomponents[17]].signalStart + 0],1ull))) std::cout << "Failed assert in template/function " << myTemplateName << " line 60. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(Fr_eq(ctx->signalValues[ctx->componentMemory[mySubcomponents[17]].signalStart + 0],1ull)));
}
{
printf("<@> out0 = ");
}
