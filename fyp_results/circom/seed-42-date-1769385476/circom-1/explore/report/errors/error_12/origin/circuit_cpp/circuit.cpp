...
void XOR_1_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void XOR_1_run(uint ctx_index,Circom_CalcWit* ctx);
...
NOT_0_create(mySignalStart+4,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_0_create(mySignalStart+6,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_2";
XOR_1_create(mySignalStart+18,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
AND_2_create(mySignalStart+21,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
NOT_0_create(mySignalStart+24,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
Mux1_4_create(mySignalStart+26,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
IsEqual_6_create(mySignalStart+34,11+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 11+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
NOT_0_create(mySignalStart+8,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
XOR_1_create(mySignalStart+10,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "comp_12";
IsZero_5_create(mySignalStart+13,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_13";
NOT_0_create(mySignalStart+16,5+ctx_index+1,ctx,new_cmp_name,myId);
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
XOR_1_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
{
Fr_mul(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[4]); // line circom 25
{{
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[5]); // line circom 25
}}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[0],&circuitConstants[6],&signalValues[mySignalStart + 0]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
cmp_index_ref_load = 10;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[0]); // line circom 46
}}
