...
GreaterEqThan_2_create(mySignalStart+9,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_3";
Mux1_4_create(mySignalStart+269,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "comp_4";
Mux1_4_create(mySignalStart+277,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
LessEqThan_5_create(mySignalStart+285,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "comp_8";
AND_6_create(mySignalStart+545,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "comp_9";
NOT_7_create(mySignalStart+548,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "comp_10";
IsZero_8_create(mySignalStart+4,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
NOT_7_create(mySignalStart+7,1+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 7;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0],&circuitConstants[2]); // line circom 41
}}
