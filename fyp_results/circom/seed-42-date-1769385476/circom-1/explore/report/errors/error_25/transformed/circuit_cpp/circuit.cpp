...
uint get_total_signal_no() {return 589;}

uint get_number_of_components() {return 20;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 529;}
...
NOT_0_create(mySignalStart+20,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "comp_1";
NOT_0_create(mySignalStart+22,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "comp_5";
LessThan_2_create(mySignalStart+321,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "comp_6";
NOT_0_create(mySignalStart+578,16+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 16+ctx_index+1;
}
{
std::string new_cmp_name = "comp_7";
Mux1_4_create(mySignalStart+580,17+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 17+ctx_index+1;
}
{
std::string new_cmp_name = "comp_11";
Mux1_4_create(mySignalStart+24,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "comp_13";
Mux1_4_create(mySignalStart+32,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "comp_17";
Mux1_4_create(mySignalStart+40,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "comp_20";
LessThan_2_create(mySignalStart+48,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "comp_23";
Mux1_4_create(mySignalStart+305,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "comp_28";
Mux1_4_create(mySignalStart+313,12+ctx_index+1,ctx,new_cmp_name,myId);
...
// load src
// end load src
signalValues[mySignalStart + 3] = Fr_bor(0ull,signalValues[mySignalStart + 2]);
// load src
// end load src
...
{
if (!Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 5],10111827412341285182ull),0ull))) std::cout << "Failed assert in template/function " << myTemplateName << " line 33. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(Fr_eq(Fr_mul(signalValues[mySignalStart + 5],10111827412341285182ull),0ull)));
}
// load src
// end load src
signalValues[mySignalStart + 6] = 4294967294ull;
// load src
// end load src
signalValues[mySignalStart + 7] = Fr_bor(Fr_neg(signalValues[mySignalStart + 5]),signalValues[mySignalStart + 6]);
{
...
cmp_index_ref_load = 4;
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 3] = ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0];
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Mux1_4_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 5;
// end load src
signalValues[mySignalStart + 0] = ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0];
// load src
// end load src
signalValues[mySignalStart + 8] = Fr_bxor(0ull,signalValues[mySignalStart + 0]);
{
...
// load src
// end load src
signalValues[mySignalStart + 10] = Fr_bxor(signalValues[mySignalStart + 9],0ull);
// load src
// end load src
signalValues[mySignalStart + 11] = Fr_bxor(signalValues[mySignalStart + 10],signalValues[mySignalStart + 0]);
{
...
cmp_index_ref_load = 7;
// end load src
signalValues[mySignalStart + 13] = Fr_mul(ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]);
{
...
// load src
// end load src
ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2] = signalValues[mySignalStart + 13];
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
LessThan_2_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
signalValues[mySignalStart + 14] = 17287609911785028448ull;
// load src
// end load src
signalValues[mySignalStart + 15] = Fr_mod(Fr_neg(signalValues[mySignalStart + 14]),18446744069414584320ull);
{
...
cmp_index_ref_load = 9;
// end load src
signalValues[mySignalStart + 16] = ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0];
// load src
// end load src
signalValues[mySignalStart + 17] = Fr_mul(signalValues[mySignalStart + 16],signalValues[mySignalStart + 16]);
// load src
// end load src
signalValues[mySignalStart + 18] = Fr_mul(signalValues[mySignalStart + 17],signalValues[mySignalStart + 16]);
// load src
// end load src
signalValues[mySignalStart + 19] = Fr_bnot(signalValues[mySignalStart + 18]);
{
...
cmp_index_ref_load = 10;
// end load src
signalValues[mySignalStart + 1] = ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0];
{
printf("<@> out0 = ");
}
{
